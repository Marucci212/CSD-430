...
public class MovieBean implements Serializable {
    ...
    // Used by Part 2/3/4 pages to list all movies
    ...
    /**
     * Deletes a movie row from justin_movies_data by primary key (movie_id).
     * Used by Project Part 4 delete JSPs.
     */
    public static void deleteMovie(int id) throws Exception {
        String sql = "DELETE FROM justin_movies_data WHERE movie_id = ?";
    ...
    // Used by select/display pages (id -> title dropdown)
